// ES5 Version of Clib WITH Prototype
...
function Circle(x, y, container) {
    ...
    this.relativeX = this.x - rect.left;
    this.relativeY = this.y - rect.top;
    ...
    this.element.style.left = (this.relativeX - this.radius) + "px"; //computation to get the left value
    this.element.style.top = (this.relativeY - this.radius) + "px"; //computation to get the top value
    ...
    this.shrink(); //start shrinking circle when created
}

//methods transferred to prototype of the Circle object
...
Circle.prototype.updateSize = function(amount){
    ...
    if (this.diameter <= 0) {
        ...
        this.element.style.height = this.diameter + "px";
        this.element.style.borderRadius = this.radius + "px";
        this.element.style.left = (this.relativeX - this.radius) + "px";
        this.element.style.top = (this.relativeY - this.radius) + "px";
    }
};
...
Clib.prototype.draw_circles = function() {
